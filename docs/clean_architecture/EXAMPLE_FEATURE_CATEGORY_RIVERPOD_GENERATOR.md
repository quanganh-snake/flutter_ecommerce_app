...
### 3.2. Category Repository Provider: 📁 `presentation/providers/category_repository_provider.dart`
...
### 3.3. Usecase Providers: 📁 `presentation/providers/category_usecase_providers.dart`
...
### 3.4. Category List Provider (READ): `presentation/providers/category_list_provider.dart`
...
@riverpod
Future<List<CategoryEntity>> categoryList(CategoryListRef ref) async {
...
### 3.5. Category Form (Create / Update): `presentation/providers/category_form_provider.dart`
...
### 3.6. elete Category: `presentation/providers/delete_category_provider.dart`
...
### 3.7. Screen: 📁 `presentation/screens/category_screen.dart`
